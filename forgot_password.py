"""This module contains OTP generation,mail_generation,password_match,forgot_password
...
def otp_generation():
    """This custom module generates OTP
    Returns:
...
def mail_generation(otp,user_mail):
    """This module is a custom module to send mail
    Args:
        otp (string): One  Time Password
        user_mail (string): User Email Address
    """
    try:
        fromaddr = input("Enter Sender mail_id : ").strip()
...
def password_match():
    """This custom function validates and returns encrypted password
